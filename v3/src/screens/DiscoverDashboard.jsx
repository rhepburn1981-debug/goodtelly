...
const DiscoverCard = ({ film, isAdded, onAdd, onClick }) => (
    <div className="wl-card" style={{ cursor: 'copy' }}>
        <div style={{ position: 'relative', borderRadius: 20, overflow: 'hidden', border: '1px solid #FFFFFF33' }} onClick={onClick}>
            <img
                src={film.poster_url || film.poster || film.image || '/branding/poster1.png'}
