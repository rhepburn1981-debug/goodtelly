    ...
    <div style={{ minHeight: '100dvh', overflowX: 'hidden', position: 'relative' }}>
      ...
      <header className="header-nav" style={{
        ...
        <div className="header-logo">
          <img src='/branding/logo.png' style={{ height: '36px', width: 'auto' }} />
        </div>
        <button
          onClick={onShowLogin}
      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        <section ref={featureScrollRef} className="feature-carousel">
          <FeatureCard title="Found something to watch in 10 seconds" subtitle="No more endless scrolling" />
          <FeatureCard title="Everything worth watching. One place." subtitle="No more jumping between Netflix, Prime or Disney+" />
          <FeatureCard title="A friend sent me a trailer — I added it instantly" subtitle="Click. Done." icon={
        ...
        <section className="section-padding-friends">
          ...
          <div style={{ textAlign: 'center', marginTop: 16 }}>
            <p className="cta-text">
              Fed up with scrolling for hours and finding nothing? We built Watch Chums to fix it.
            </p>
            <button
              onClick={onShowRegister}
